...
with app.app_context():
    ...
    # Seed SOA controls if empty
    try:
        if SoAControl.query.count() == 0:
            CONTROLS = [
                ...
                ("8.1","User end point devices","Technological"),
